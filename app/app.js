document.addEventListener('DOMContentLoaded', async () => {
    ...
    function showShareDayPicker() {
        ...
        html += '<h2 style="text-align:center;margin-bottom:1rem">Оберіть день для експорту</h2>';
        html += `<button class="share-day-btn share-day-primary" data-day="week">
            <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2" fill="none"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> Весь тиждень
        </button>`;
